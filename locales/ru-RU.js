...
export default {
  ...
  pages: {
    ...
    modeling: {
      ...
      blender:
        'C июня 2025 года начал моделитьвать в Blender. Моделирую не часто, но занятие интересное.',
    },
    photoshop: {
      message:
    ...
    printing: {
      message:
        'Полиграфия включает в себя печать книг, журналов, листовок, стикеров, наклеек, бирок и много другой продукции информативного и рекламирующего типа. Я не специализируюсь в этой области, но несколько раз ко мне обращались с задачами подобной тематики и я охотно взялся за них. Результаты работ представлены на этой странице.',
    },
    projects: {
      message:
