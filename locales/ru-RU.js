    ...
    pricing: {
      sections: {
        ...
        deadline: {
          heading: 'Сроки',
          message:
            'В среднем, учитывая этап согласования технического задания, внутренние утверждения на стороне клиента и длительность работ по созданию, редизайну и разработке некоторых элементов сайта могут составляют от 2 дней до 3 месяцев. Более подробную информацию, вы можете найти в списке, расположенном выше, дважды щелкнув по выбранной услуге.',
          calculate: {
            question: 'Как быстро разрабатывается сайт?',
            message:
              'Сайт — это не баннер и не буклет. Сайт — это проект разной сложности. Цена за сайт начинается с объема дизайна. Что это за сайт? Что включает в себя дизайн сайта стилистически? Сколько у него страниц? Простой ли это сайт в духе минимализма? Будет ли дизайн адаптивен? И прочее.',
            more: '',
          },
        },
        cost: {
          heading: 'Расчет стоимости услуг',
          calculate: {
