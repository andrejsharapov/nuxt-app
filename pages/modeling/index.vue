...
.page__3d-modeling
  ...
  v-container
    v-row
      v-col(cols='12', md='9')
        p(v-html="$t('pages.modeling.message', { pack: \"<a href='/projects' target='_blank' title=''>texture pack</a>\", blockbench: \"<a href='https://www.blockbench.net/' target='_blank' title=''>blockbench</a>\"})")
