<template lang="pug">
.case-header
  v-card.z-index-2.position-relative(v-box-shadow='9')
      ...
      v-col.pt-4(cols='12', sm='7')
        ...
        template(v-if='info.resize')
          v-card-subtitle.pl-0.pt-4.text-center.text-sm-left
            ...
            template(
              v-for='(name, i) in Array.isArray(info.resize) ? info.resize : [info.resize]'
            )
  ...
  v-row.mt-4
    ...
    v-col(cols='12', md='6')
      s-pages-cases-components-slug-components-header-tabs(
        :heading='$t("pages.cases.slug.header-tabs[0]")',
        :content='info.preview.tools'
      )
    v-col(cols='12', md='6')
      s-pages-cases-components-slug-components-header-tabs(
        :heading='$t("pages.cases.slug.header-tabs[1]")',
        :content='info.preview.roles'
      )
    //- /COMPONENT
</template>
